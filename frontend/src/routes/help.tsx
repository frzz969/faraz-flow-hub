          ...
          <SectionCard title="Contact support" subtitle="We usually reply within one business day">
            <div className="space-y-3">
              ...
              <Button
                ...
                onClick={() => {
                  window.location.href = "mailto:operations@farazzflow.example.com?subject=FARAZZ%20FLOW%20support%20ticket";
                  toast.success("Opening your mail client to create a support ticket.");
                }}
              >
